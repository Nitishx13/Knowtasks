          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                className="bg-gray-700 hover:bg-gray-600 px-6 py-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </Button>
              ...
              <Button
                ...
                className="bg-orange-600 hover:bg-orange-700 px-6 py-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <AnimatePresence>
            {filteredQuizzes.length > 0 ? (
                      ...
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-400 text-sm">
                            {new Date(quiz.created_at).toLocaleDateString()} • {quiz.questions?.length || 0} questions
                          </p>
                        </div>
                      </div>
                      {quiz.subject && (
                        <span className="px-2 py-1 bg-green-600 text-xs rounded-full">{quiz.subject}</span>
                      )}
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">Create your first quiz to test your knowledge</p>
              </div>
            )}
          </AnimatePresence>
        </div>
